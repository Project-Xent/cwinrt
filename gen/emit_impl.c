...
static int emit_static_activate_vtable(int bd, cwinrt_mapped_method const *m) {
	...
	return bprint(
               ...
               "        cwinrt_inst_fn_t fn = (cwinrt_inst_fn_t)((void **)((IUnknown *)inst)->lpVtbl)[%u];\n"
               "        hr = fn(inst%s%s);\n"
               "    }\n"
...
static int emit_static_vtable_direct(int bd, cwinrt_mapped_method const *m) {
	...
	return bprint(
               ...
               "        cwinrt_static_fn_t fn = (cwinrt_static_fn_t)((void **)((IUnknown *)statics)->lpVtbl)[%u];\n"
               "        hr = fn(statics%s%s);\n"
               "    }\n"
...
static int emit_instance_vtable(int bd, cwinrt_mapped_method const *m) {
	...
	if (m->dispatch_iface_c && m->dispatch_has_iid) {
		...
		return bprint(
		  ...
		  "        cwinrt_fn_t fn = (cwinrt_fn_t)((void **)((IUnknown *)cwinrt_disp_)->lpVtbl)[%u];\n"
	...
	return bprint(
               ...
               "    typedef HRESULT (__stdcall *cwinrt_fn_t)(%s);\n"
               "    cwinrt_fn_t fn = (cwinrt_fn_t)((void **)cwinrt_obj_->lpVtbl)[%u];\n"
               "    return fn(%s);\n"
               "}\n\n",
               m->c_sig,
               m->params_c,
...
static int emit_event_pair_direct(int bd, emit_event_ctx const *e) {
	return bprint(
	         ...
	         "    hr = cwinrt_event_subscribe((IUnknown *)self, %uu, %uu, handler, &eh);\n"
	         ...
	         "{\n"
	         "    cwinrt_event_handle eh = { (IUnknown *)self, %uu, token };\n"
...
static int emit_event_pair_qi(int bd, emit_event_ctx const *e) {
	...
	return bprint(
	         ...
	         "    hr = cwinrt_event_subscribe((IUnknown *)cwinrt_disp_, %uu, %uu, handler, &eh);\n"
	         "    handler->lpVtbl->Release(handler);\n"
	         "    ((IUnknown *)cwinrt_disp_)->lpVtbl->Release((IUnknown *)cwinrt_disp_);\n"
	         "    if (FAILED(hr)) return tok;\n"
	         "    return eh.token;\n"
	         ...
	         "    if (FAILED(hr)) return;\n"
	         "    {\n"
	         "        cwinrt_event_handle eh = { (IUnknown *)cwinrt_disp_, %uu, token };\n"
	         "        cwinrt_event_unsubscribe(&eh);\n"
	         "    }\n"
	         "    ((IUnknown *)cwinrt_disp_)->lpVtbl->Release((IUnknown *)cwinrt_disp_);\n"
	         "}\n\n",
